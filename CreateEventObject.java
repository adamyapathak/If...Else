...
public class CreateEventObject {
    public static void main(String[] args){
        ...
        final String CORP_MANAGER = " Carmen Lindsy ";
            ...
            if(eventType == CORPORATE_CODE){
                ...
                if(eventType == NONPROFIT_CODE){
                    ...
                    if(choiceIsGood){
                        ...
                        System.out.println(" Type: " + scheduledEvent.getType() + " Rate: " + scheduledEvent.getRate() + " per hour ");

                //If necessary, rename this file to CreateEventObjectSwitch.java and delete the if...else statement and replace that with switch statement and structure. 
   }
}
